...
import { 
  ...
  Building2, Zap, LayoutGrid, Smartphone, MapPin
} from 'lucide-react';
    ...
    <div className="max-w-5xl mx-auto space-y-10 animate-sb-entry pb-20">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
         <div>
            ...
            <p className="text-xs text-[#686868] mt-1 font-medium">Identité numérique et accès sécurisé Horizon Pro.</p>
         </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          {/* Identity Card */}
          <div className="sb-card p-0 overflow-hidden border-[#ededed] shadow-sm bg-white">
            <div className="h-32 bg-[#1c1c1c] relative">
               <div className="absolute top-0 right-0 p-6 opacity-10">
                  <ShieldCheck size={140} className="text-[#3ecf8e]" />
               </div>
               <div className="absolute -bottom-14 left-8 p-1.5 bg-white rounded-2xl shadow-lg border border-[#ededed]">
                 <img src={currentUser.avatar} className="w-28 h-28 rounded-xl object-cover bg-[#f8f9fa]" alt="" />
               </div>
            </div>
            <div className="pt-20 px-8 pb-8 space-y-8">
               <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <BadgeCheck size={20} className="text-[#3ecf8e]" />
                    </div>
                    <p className="text-[10px] text-[#3ecf8e] font-black uppercase tracking-[0.2em] mt-1">Expert Certifié Royal Plaza • GABON</p>
                  </div>
                  <div className="flex flex-col items-end">
                    <span className="px-3 py-1 bg-[#f0fdf4] text-[#16a34a] border border-[#dcfce7] text-[10px] font-black uppercase rounded-full">
                      {currentUser.role}
                    </span>
                    <p className="text-[9px] text-[#686868] mt-1 font-bold">Niveau d'accréditation 4</p>
                  </div>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-[#f5f5f5]">
                  <div className="space-y-1.5">
                    ...
                    <input 
                      type="text" 
                      disabled={!isEditing} 
                      className={`w-full h-11 transition-all ${!isEditing ? 'bg-[#fcfcfc] border-transparent cursor-not-allowed font-semibold' : 'bg-white border-[#ededed]'}`} 
                      value={formData.name} 
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="h-11 px-4 bg-[#f8f9fa] border border-[#ededed] rounded-lg flex items-center gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-[#3ecf8e] animate-pulse" />
                      <span className="text-xs font-bold text-[#1c1c1c]">Actif • GAB-Cluster-01</span>
                    </div>
                  </div>
               </div>
            </div>
          ...
          <div className="sb-card bg-white border-[#ededed] p-8 space-y-6 shadow-sm">
             <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-[#1c1c1c] uppercase tracking-widest">Contrôle de Sécurité</h3>
                  <p className="text-[10px] text-[#686868] font-medium">Identifiants et authentification Horizon</p>
                </div>
             </div>
                ...
                <div className="flex items-center justify-between">
                   <div className="flex items-center gap-6">
                      ...
                      <div className="flex-1 min-w-0">
                         <p className="text-[9px] font-black text-[#686868] uppercase mb-1">Clé d'Accès Système</p>
                         <input 
              ...
              <div className="space-y-4">
                <div className="p-4 bg-[#f0fdf4] rounded-xl flex items-center justify-between border border-[#dcfce7]">
                   <div className="flex items-center gap-3">
                      ...
                      <span className="text-[11px] font-bold text-[#16a34a] uppercase">Connecté</span>
                   </div>
                ...
                <div className="space-y-2.5">
                   <div className="flex justify-between text-[11px]">
                      <span className="text-[#686868] font-medium">Session IP</span>
                      <span className="text-[#1c1c1c] font-black">197.234.xx.xx</span>
                   </div>
                   <div className="flex justify-between text-[11px]">
                      <span className="text-[#686868] font-medium">Agent Web</span>
                      <span className="text-[#1c1c1c] font-black">V8 Engine</span>
                   </div>
                   <div className="flex justify-between text-[11px]">
                      <span className="text-[#686868] font-medium">Cryptage</span>
                      <span className="text-[#1c1c1c] font-black">AES-256</span>
                   </div>
                   <div className="flex justify-between text-[11px]">
                      <span className="text-[#686868] font-medium">Uptime</span>
                      <span className="text-[#1c1c1c] font-black">99.9%</span>
                   </div>
                </div>
              </div>

              <div className="bg-[#f8f9fa] p-4 rounded-xl border border-[#ededed]">
                 <p className="text-[10px] text-[#686868] font-medium leading-relaxed italic">
